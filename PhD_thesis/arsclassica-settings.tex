...
% Personal commands
% ******************************************************************** 
\newcommand{\myTitle}{Modular structure of chiral Fermi fields 
		      in conformal quantum field theory}
\newcommand{\mySubtitle}{}
\newcommand{\myName}{Gennaro Tedesco}
\newcommand{\myProf}{Karl-Henning Rehren}
\newcommand{\myOtherProf}{Dorothea Bahns}
\newcommand{\mySupervisor}{Put name here}
\newcommand{\myFaculty}{Graduiertenkolleg 1493,
                        ``Mathematische Strukturen in
                       der modernen Quantenfeldtheorie''}
\newcommand{\myDepartment}{Institute for Theoretical Physics}
\newcommand{\myUni}{Georg-August-Universit\"at 
                    G\"ottingen}
\newcommand{\myLocation}{G\"ottingen}
